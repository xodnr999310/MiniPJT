      ...
      <form name="detailForm" action="/listProduct.do" method="post">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                     <tr>
                        <td width="93%" class="ct_ttl01">
                        			${ menuType eq 'manage' ? '상품 관리' : '상품 검색'}
                        </td>
                     </tr>
                  </table>
               </td>
         ...
         <table width="100%" border="0" cellspacing="0" cellpadding="0"
            ...
            <tr class="ct_list_pop">
               ...
               <td></td>
               <td align="center">
               <a href="/${ menuType eq 'manage' ? 'updateProductView' : 'getProduct'}.do?prodNo=${product.prodNo}">${product.prodNo}</a>
               ...
               <td></td>
  			   <td align="left"><c:if test="${ user.role eq 'admin' && menuType eq 'manage' }"> 
							<c:choose>
